...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RollId', function() {
      beforeEach(function() {
        instance = new SimplePostPutPatchAndDeleteApi.RollId();
      });

      it('should create an instance of RollId', function() {
        // TODO: update the code to test RollId
        expect(instance).to.be.a(SimplePostPutPatchAndDeleteApi.RollId);
      });
