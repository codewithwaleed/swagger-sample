...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplePostPutPatchAndDeleteApi.DeleteStudentApi();
  });

  describe('(package)', function() {
    describe('DeleteStudentApi', function() {
      describe('deleteStudent', function() {
        it('should call deleteStudent successfully', function(done) {
          ...
          instance.deleteStudent(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
