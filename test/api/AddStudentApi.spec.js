...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimplePostPutPatchAndDeleteApi.AddStudentApi();
  });

  describe('(package)', function() {
    describe('AddStudentApi', function() {
      describe('addStudent', function() {
        it('should call addStudent successfully', function(done) {
          // TODO: uncomment, update parameter values for addStudent call
          /*
          var opts = {};
          ...
          instance.addStudent(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
