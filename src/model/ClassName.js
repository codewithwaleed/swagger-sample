...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimplePostPutPatchAndDeleteApi.ClassName = factory(root.SimplePostPutPatchAndDeleteApi.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ClassName</code>.
   * @alias module:model/ClassName
   * @class
   */
   ...
   * @return {module:model/ClassName} The populated <code>ClassName</code> instance.
   */
